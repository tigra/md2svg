 ...
 */
export const measureNaturalContentWidth = (
    htmlContent,
    ...
    return Math.max(Math.min(maxLineWidth, maxWidth), minWidth);
};
...
export const createConverters = (deps) => {
    ...
    return {
        ...
        markdownToNativeSVG(markdownContent) {
            ...
            // Use exported helper function to get optimal content width
        ...
        async htmlToDomToSvgModuleSVG(htmlElement) {
            try {
                ...
                // Use exported helper function to get optimal content width with a minimum width of 40px
                const width = measureNaturalContentWidth(htmlElement.innerHTML, 'Segoe UI, Tahoma, Geneva, Verdana, sans-serif', SVG_MAX_WIDTH, 40);
